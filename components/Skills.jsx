				...
				<div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
					...
					<div className="p-6 shadow-xl shadow-gray-500 rounded-xl hover:scale-105 ease-in duration-300">
						<div className="grid grid-cols-2 gap-4 justify-center items-center">
							<div className="m-auto">
								<Image
									src="/../public/images/skills/mongodb.png"
									alt="/"
									width="64px"
									height="64px"
								/>
					...
					<div className="p-6 shadow-xl shadow-gray-500 rounded-xl hover:scale-105 ease-in duration-300">
						<div className="grid grid-cols-2 gap-4 justify-center items-center">
							<div className="m-auto">
								<Image
									src="/../public/images/skills/python.png"
									alt="/"
									width="64px"
									height="64px"
								/>
					...
					<div className="p-6 shadow-xl shadow-gray-500 rounded-xl hover:scale-105 ease-in duration-300">
						<div className="grid grid-cols-2 gap-4 justify-center items-center">
							<div className="m-auto">
								<Image
									src="/../public/images/skills/github1.png"
									alt="/"
									width="64px"
									height="64px"
								/>
					...
					<div className="p-6 shadow-xl shadow-gray-500 rounded-xl hover:scale-105 ease-in duration-300">
						<div className="grid grid-cols-2 gap-4 justify-center items-center">
							<div className="m-auto">
								<Image
									src="/../public/images/skills/django.png"
									alt="/"
									width="64px"
									height="64px"
								/>
					...
					<div className="p-6 shadow-xl shadow-gray-500 rounded-xl hover:scale-105 ease-in duration-300">
						<div className="grid grid-cols-2 gap-4 justify-center items-center">
							<div className="m-auto">
								<Image
									src="/../public/images/skills/npm.png"
									alt="/"
									width="64px"
									height="64px"
								/>
